...
- Suggest updates to Layer 1 assets (copilot-instructions.md, plan templates, commands)
...
.agent-module/commands/plan-feature.md
...
.agent-module/commands/execute.md
...
- **copilot-instructions.md updates:** Universal patterns or anti-patterns to document
...
Save your analysis to: `.agent-module/system-reviews/[feature-name]-review.md`
...
- [ ] Used documented patterns (from copilot-instructions.md)
...
- **Suggest improvements:** Don't just analyze - actually suggest the text to add to copilot-instructions.md or commands
